...
func (bcc *BlogCategoryCreate) SetSortOrder(i int) *BlogCategoryCreate {
	bcc.mutation.SetSortOrder(i)
	return bcc
}

// SetNillableSortOrder sets the "sort_order" field if the given value is not nil.
func (bcc *BlogCategoryCreate) SetNillableSortOrder(i *int) *BlogCategoryCreate {
	if i != nil {
		bcc.SetSortOrder(*i)
	}
	return bcc
...
func (bcc *BlogCategoryCreate) AddTranslations(b ...*BlogCategoryTranslation) *BlogCategoryCreate {
	...
	return bcc.AddTranslationIDs(ids...)
}
...
func (bcc *BlogCategoryCreate) defaults() {
	if _, ok := bcc.mutation.SortOrder(); !ok {
		v := blogcategory.DefaultSortOrder
...
func (bcc *BlogCategoryCreate) createSpec() (*BlogCategory, *sqlgraph.CreateSpec) {
	...
	if nodes := bcc.mutation.TranslationsIDs(); len(nodes) > 0 {

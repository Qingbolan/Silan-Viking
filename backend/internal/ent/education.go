...
// QueryDetails queries the "details" edge of the Education entity.
func (e *Education) QueryDetails() *EducationDetailQuery {
	return NewEducationClient(e.config).QueryDetails(e)
}

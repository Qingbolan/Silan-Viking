...
// QueryDetails queries the "details" edge of the ResearchProject entity.
func (rp *ResearchProject) QueryDetails() *ResearchProjectDetailQuery {
	return NewResearchProjectClient(rp.config).QueryDetails(rp)
}

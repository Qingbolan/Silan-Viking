...
func (bcu *BlogCategoryUpdate) SetSortOrder(i int) *BlogCategoryUpdate {
...
func (bcu *BlogCategoryUpdate) SetNillableSortOrder(i *int) *BlogCategoryUpdate {
	if i != nil {
		bcu.SetSortOrder(*i)
	}
	return bcu
...
func (bcu *BlogCategoryUpdate) AddSortOrder(i int) *BlogCategoryUpdate {
...
func (bcu *BlogCategoryUpdate) AddTranslations(b ...*BlogCategoryTranslation) *BlogCategoryUpdate {
...
// ClearTranslations clears all "translations" edges to the BlogCategoryTranslation entity.
func (bcu *BlogCategoryUpdate) ClearTranslations() *BlogCategoryUpdate {
	bcu.mutation.ClearTranslations()
	return bcu
}

// RemoveTranslationIDs removes the "translations" edge to BlogCategoryTranslation entities by IDs.
func (bcu *BlogCategoryUpdate) RemoveTranslationIDs(ids ...string) *BlogCategoryUpdate {
	bcu.mutation.RemoveTranslationIDs(ids...)
	return bcu
}

// RemoveTranslations removes "translations" edges to BlogCategoryTranslation entities.
func (bcu *BlogCategoryUpdate) RemoveTranslations(b ...*BlogCategoryTranslation) *BlogCategoryUpdate {
	ids := make([]string, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
...
func (bcu *BlogCategoryUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(blogcategory.Table, blogcategory.Columns, sqlgraph.NewFieldSpec(blogcategory.FieldID, field.TypeString))
	...
	if value, ok := bcu.mutation.SortOrder(); ok {
		_spec.SetField(blogcategory.FieldSortOrder, field.TypeInt, value)
	}
	...
	if bcu.mutation.TranslationsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   blogcategory.TranslationsTable,
	...
	if nodes := bcu.mutation.RemovedTranslationsIDs(); len(nodes) > 0 && !bcu.mutation.TranslationsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   blogcategory.TranslationsTable,
	...
	if nodes := bcu.mutation.TranslationsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   blogcategory.TranslationsTable,
...
// SetSortOrder sets the "sort_order" field.
func (bcuo *BlogCategoryUpdateOne) SetSortOrder(i int) *BlogCategoryUpdateOne {
...
// SetNillableSortOrder sets the "sort_order" field if the given value is not nil.
func (bcuo *BlogCategoryUpdateOne) SetNillableSortOrder(i *int) *BlogCategoryUpdateOne {
	if i != nil {
		bcuo.SetSortOrder(*i)
	}
	return bcuo
...
// AddSortOrder adds i to the "sort_order" field.
func (bcuo *BlogCategoryUpdateOne) AddSortOrder(i int) *BlogCategoryUpdateOne {
...
// AddTranslations adds the "translations" edges to the BlogCategoryTranslation entity.
func (bcuo *BlogCategoryUpdateOne) AddTranslations(b ...*BlogCategoryTranslation) *BlogCategoryUpdateOne {
	ids := make([]string, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
...
// ClearTranslations clears all "translations" edges to the BlogCategoryTranslation entity.
func (bcuo *BlogCategoryUpdateOne) ClearTranslations() *BlogCategoryUpdateOne {
	bcuo.mutation.ClearTranslations()
	return bcuo
}

// RemoveTranslationIDs removes the "translations" edge to BlogCategoryTranslation entities by IDs.
func (bcuo *BlogCategoryUpdateOne) RemoveTranslationIDs(ids ...string) *BlogCategoryUpdateOne {
	bcuo.mutation.RemoveTranslationIDs(ids...)
	return bcuo
}

// RemoveTranslations removes "translations" edges to BlogCategoryTranslation entities.
func (bcuo *BlogCategoryUpdateOne) RemoveTranslations(b ...*BlogCategoryTranslation) *BlogCategoryUpdateOne {
	ids := make([]string, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
...
func (bcuo *BlogCategoryUpdateOne) sqlSave(ctx context.Context) (_node *BlogCategory, err error) {
	...
	if nodes := bcuo.mutation.RemovedTranslationsIDs(); len(nodes) > 0 && !bcuo.mutation.TranslationsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   blogcategory.TranslationsTable,
	...
	if nodes := bcuo.mutation.TranslationsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   blogcategory.TranslationsTable,

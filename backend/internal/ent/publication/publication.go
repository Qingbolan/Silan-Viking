...
const (
	...
	TranslationsTable = "publication_translations"
	// TranslationsInverseTable is the table name for the PublicationTranslation entity.
	// It exists in this package in order to avoid circular dependency with the "publicationtranslation" package.
	TranslationsInverseTable = "publication_translations"
	// TranslationsColumn is the table column denoting the translations relation/edge.
	TranslationsColumn = "publication_id"
	// AuthorsTable is the table that holds the authors relation/edge.
	AuthorsTable = "publication_authors"
	// AuthorsInverseTable is the table name for the PublicationAuthor entity.
	// It exists in this package in order to avoid circular dependency with the "publicationauthor" package.
	AuthorsInverseTable = "publication_authors"
	// AuthorsColumn is the table column denoting the authors relation/edge.
	AuthorsColumn = "publication_id"
)

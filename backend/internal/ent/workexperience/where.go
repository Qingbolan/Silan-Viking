...
func HasTranslations() predicate.WorkExperience {
...
func HasTranslationsWith(preds ...predicate.WorkExperienceTranslation) predicate.WorkExperience {
	return predicate.WorkExperience(func(s *sql.Selector) {
...
func HasDetails() predicate.WorkExperience {
	return predicate.WorkExperience(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasDetailsWith(preds ...predicate.WorkExperienceDetail) predicate.WorkExperience {
	return predicate.WorkExperience(func(s *sql.Selector) {
		step := newDetailsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {

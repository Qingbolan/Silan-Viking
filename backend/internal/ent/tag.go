...
type Tag struct {
	config `json:"-"`
	// ID of the ent.
	// normalised slug; same value as `slug`. Primary key.
	ID string `json:"id,omitempty"`
	// kebab-case slug, e.g. `ai-ml`
	Slug string `json:"slug,omitempty"`
	// original free-text label, e.g. `AI / ML`
...
func (*Tag) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case tag.FieldID, tag.FieldSlug, tag.FieldLabel:

...
func (eu *EducationUpdate) ClearTranslations() *EducationUpdate {
...
// ClearDetails clears all "details" edges to the EducationDetail entity.
func (eu *EducationUpdate) ClearDetails() *EducationUpdate {
	eu.mutation.ClearDetails()
	return eu
}
...
func (eu *EducationUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := eu.mutation.RemovedDetailsIDs(); len(nodes) > 0 && !eu.mutation.DetailsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   education.DetailsTable,
	...
	if nodes := eu.mutation.DetailsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   education.DetailsTable,
...
// ClearTranslations clears all "translations" edges to the EducationTranslation entity.
func (euo *EducationUpdateOne) ClearTranslations() *EducationUpdateOne {
...
// ClearDetails clears all "details" edges to the EducationDetail entity.
func (euo *EducationUpdateOne) ClearDetails() *EducationUpdateOne {
	euo.mutation.ClearDetails()
	return euo
}
...
func (euo *EducationUpdateOne) RemoveDetails(e ...*EducationDetail) *EducationUpdateOne {
	...
	return euo.RemoveDetailIDs(ids...)
}
...
func (euo *EducationUpdateOne) sqlSave(ctx context.Context) (_node *Education, err error) {
	...
	if euo.mutation.DetailsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   education.DetailsTable,
	...
	if nodes := euo.mutation.RemovedDetailsIDs(); len(nodes) > 0 && !euo.mutation.DetailsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   education.DetailsTable,
	...
	if nodes := euo.mutation.DetailsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   education.DetailsTable,

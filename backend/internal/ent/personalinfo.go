...
func (pi *PersonalInfo) QueryTranslations() *PersonalInfoTranslationQuery {
	return NewPersonalInfoClient(pi.config).QueryTranslations(pi)
}

// QuerySocialLinks queries the "social_links" edge of the PersonalInfo entity.
func (pi *PersonalInfo) QuerySocialLinks() *SocialLinkQuery {
	return NewPersonalInfoClient(pi.config).QuerySocialLinks(pi)
}
...
func (pi *PersonalInfo) String() string {
	...
	builder.WriteString(pi.CurrentStatus)
	builder.WriteString(", ")
	...
	builder.WriteString(pi.AvatarURL)
	builder.WriteString(", ")

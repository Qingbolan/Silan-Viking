...
func (weu *WorkExperienceUpdate) AddTranslations(w ...*WorkExperienceTranslation) *WorkExperienceUpdate {
	...
	return weu.AddTranslationIDs(ids...)
}
...
func (weu *WorkExperienceUpdate) ClearTranslations() *WorkExperienceUpdate {
	weu.mutation.ClearTranslations()
	return weu
}
...
func (weu *WorkExperienceUpdate) RemoveTranslations(w ...*WorkExperienceTranslation) *WorkExperienceUpdate {
	...
	return weu.RemoveTranslationIDs(ids...)
}

// ClearDetails clears all "details" edges to the WorkExperienceDetail entity.
func (weu *WorkExperienceUpdate) ClearDetails() *WorkExperienceUpdate {
	weu.mutation.ClearDetails()
	return weu
}
...
func (weu *WorkExperienceUpdate) RemoveDetails(w ...*WorkExperienceDetail) *WorkExperienceUpdate {
	...
	return weu.RemoveDetailIDs(ids...)
}
...
func (weu *WorkExperienceUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if weu.mutation.TranslationsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   workexperience.TranslationsTable,
	...
	if nodes := weu.mutation.RemovedTranslationsIDs(); len(nodes) > 0 && !weu.mutation.TranslationsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   workexperience.TranslationsTable,
	...
	if nodes := weu.mutation.TranslationsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   workexperience.TranslationsTable,
	...
	if weu.mutation.DetailsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   workexperience.DetailsTable,
	...
	if nodes := weu.mutation.RemovedDetailsIDs(); len(nodes) > 0 && !weu.mutation.DetailsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   workexperience.DetailsTable,
	...
	if nodes := weu.mutation.DetailsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   workexperience.DetailsTable,
...
func (weuo *WorkExperienceUpdateOne) AddTranslations(w ...*WorkExperienceTranslation) *WorkExperienceUpdateOne {
	...
	return weuo.AddTranslationIDs(ids...)
}
...
// ClearTranslations clears all "translations" edges to the WorkExperienceTranslation entity.
func (weuo *WorkExperienceUpdateOne) ClearTranslations() *WorkExperienceUpdateOne {
	weuo.mutation.ClearTranslations()
	return weuo
}
...
func (weuo *WorkExperienceUpdateOne) RemoveTranslations(w ...*WorkExperienceTranslation) *WorkExperienceUpdateOne {
	...
	return weuo.RemoveTranslationIDs(ids...)
}

// ClearDetails clears all "details" edges to the WorkExperienceDetail entity.
func (weuo *WorkExperienceUpdateOne) ClearDetails() *WorkExperienceUpdateOne {
	weuo.mutation.ClearDetails()
	return weuo
}
...
func (weuo *WorkExperienceUpdateOne) RemoveDetails(w ...*WorkExperienceDetail) *WorkExperienceUpdateOne {
	...
	return weuo.RemoveDetailIDs(ids...)
}
...
func (weuo *WorkExperienceUpdateOne) sqlSave(ctx context.Context) (_node *WorkExperience, err error) {
	...
	if nodes := weuo.mutation.RemovedTranslationsIDs(); len(nodes) > 0 && !weuo.mutation.TranslationsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   workexperience.TranslationsTable,
	...
	if nodes := weuo.mutation.TranslationsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   workexperience.TranslationsTable,
	...
	if weuo.mutation.DetailsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   workexperience.DetailsTable,
	...
	if nodes := weuo.mutation.RemovedDetailsIDs(); len(nodes) > 0 && !weuo.mutation.DetailsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   workexperience.DetailsTable,
	...
	if nodes := weuo.mutation.DetailsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   workexperience.DetailsTable,

...
const (
	// Label holds the string label denoting the blogcategory type in the database.
	Label = "blog_category"
	...
	// Table holds the table name of the blogcategory in the database.
	Table = "blog_categories"
	// TranslationsTable is the table that holds the translations relation/edge.
	TranslationsTable = "blog_category_translations"
	// TranslationsInverseTable is the table name for the BlogCategoryTranslation entity.
	// It exists in this package in order to avoid circular dependency with the "blogcategorytranslation" package.
	TranslationsInverseTable = "blog_category_translations"
	// TranslationsColumn is the table column denoting the translations relation/edge.
	TranslationsColumn = "blog_category_id"
	...
	BlogPostsColumn = "category_id"
)

// Columns holds all SQL columns for blogcategory fields.
var Columns = []string{
	FieldID,
	FieldName,
	FieldSlug,
...
// OrderOption defines the ordering options for the BlogCategory queries.

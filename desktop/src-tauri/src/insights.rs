    ...
    pub(crate) fn snapshot(&self) -> Result<RuntimeInsights, String> {
        ...
        let (
            ...
            (
                ...
                self.scalar_i64(
                    "SELECT COUNT(*) FROM content_interaction WHERE visitor_kind = 'ai_crawler'",
                )?,
                self.scalar_i64(
                    "SELECT COUNT(*) FROM content_interaction WHERE visitor_kind = 'search_crawler'",
                )?,
            )
        } else {
            (0, 0, 0, 0)
    ...
    fn runtime_snapshot_counts_available_observations() {
        ...
        connection
            .execute_batch(
                ...
                INSERT INTO content_interaction VALUES ('human'), ('ai_crawler'), ('search_crawler');
                ",
            )
        ...
        assert_eq!(
            ...
            RuntimeInsights {
                ...
                ai_crawler_interactions: 1,
                search_crawler_interactions: 1,
            }
        );
    }
}

...
func (uiq *UserIdentityQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (uiq *UserIdentityQuery) FirstIDX(ctx context.Context) string {
...
func (uiq *UserIdentityQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (uiq *UserIdentityQuery) OnlyIDX(ctx context.Context) string {
...
func (uiq *UserIdentityQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (uiq *UserIdentityQuery) IDsX(ctx context.Context) []string {
	ids, err := uiq.IDs(ctx)
	if err != nil {
		panic(err)
	}

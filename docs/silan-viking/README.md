...
| [`14-漂移诊断与逐里程碑收敛.md`](./14-漂移诊断与逐里程碑收敛.md) | 文档漂移的诊断流程与逐里程碑收敛纪律 | 已定 |
| [`15-agent自我演化.md`](./15-agent自我演化.md) | agent 主动演化项目的三层设计与闸门;E1–E3 阶段(已接入 `04`)| 已定 |
| [`16-终局制品交付部署.md`](./16-终局制品交付部署.md) | 终局制品的交付与部署 | 已定 |
| [`17-单一事实源.md`](./17-单一事实源.md) | **SSOT** —— 易漂移的全局定义集中钉死 + 一致性自检清单(根治文档漂移)| 已定 |
